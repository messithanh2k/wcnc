...
algorithm = GraphRlOptimizer(args=args, env=env, T=args.time_T, testedT=testedT)
...
file = open('{}/{}_{}_{}_{}.txt'.format(result_dir, args.dataset, args.algo, args.time_test, args.time_T), 'a')
...
file.write('Time: ' + str(env.now) + ' The number of dead node:' + str(net.countDeadNodes()) + '\n')
file.write('\n')
file.write('\n')
file.close()